...
% ------------------------------------------------------------------------
% Folha de aprovacao com a banca completa
% ------------------------------------------------------------------------
% A classe so imprime o segundo membro da UEM e o segundo membro externo
...
% titulares, entao a folha e redefinida aqui com a mesma estrutura e a mesma
% ordem da classe, apenas listando os quatro. A classe permanece intacta.
\makeatletter
\renewcommand{\inserefolhaaprovacao}{%
    ...
    \ifthenelse{\equal{\imprimirigeneroOR}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimirorientador\\
    \imprimiriesorientador

    \vspace{6mm}

    \ifthenelse{\equal{\imprimirigeneroCOOR}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimircoorientador\\
    \imprimiriescoorientador

    \vspace{6mm}

    \ifthenelse{\equal{\imprimirigeneroUEMA}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimirbancauemnomeA\\
    \imprimirbancaueminstituicaoA

    \vspace{6mm}

    \ifthenelse{\equal{\imprimirigeneroUEMB}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimirbancauemnomeB\\
    \imprimirbancaueminstituicaoB

    \vspace{6mm}

    \ifthenelse{\equal{\imprimirigeneroExteriorA}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimirbancaexternonomeA\\
    \imprimirbancaexternoinstituicaoA

    \vspace{6mm}

    \ifthenelse{\equal{\imprimirigeneroExteriorB}{M}}{Prof. Dr.}{Profa. Dra.}
    \imprimirbancaexternonomeB\\
    \imprimirbancaexternoinstituicaoB

    \begin{flushleft}
    \begin{textblock*}{144mm}(30mm,270mm)
    Aprovada em: \imprimirdataaprovacao.

    Local da defesa: \imprimirlocaldefesa.
    \end{textblock*}
    \end{flushleft}
...
% (qualification exam scheduled for September 3, 2026)
\dataaprovacao{September 3, 2026}
