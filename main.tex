...
\dataaprovacao{September 15, 2026}
...
% ------------------------------------------------------------------------
% Annexes: published and accepted articles produced during the doctorate
% ------------------------------------------------------------------------
\begin{anexosenv}
\partanexos
...
\label{anexo:sbes}
\includepdf[pages=-]{anexos/anexo-c-sbes2026.pdf}
