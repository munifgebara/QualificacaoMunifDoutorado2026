...
\midrule
Representation & Source code minimaps as compact visual signatures of software artifacts. & Partially validated \\
Anonymization & Transformations that reduce lexical exposure while preserving layout and symbols. & Partially validated \\
Datasets & Minimap image corpora with metadata catalogs and supervised objectives. & Partially available \\
Modeling & Classical texture-based and deep learning pipelines for minimap classification. & Partially validated \\
Explainability & Attribution analysis to interpret visual evidence used by models. & Initial results \\
Tool support & IDE plugins and backend services for practical minimap-based analysis. & Prototype available \\
