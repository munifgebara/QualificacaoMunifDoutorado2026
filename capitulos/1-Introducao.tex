...
enough to retain discriminative signals, and capable of suppressing lexical
content so that business-sensitive information never leaves the local environment.
Source code minimaps are proposed as this abstraction.
...
intellectual property protection, and tool support. RQ1 and RQ2 address the
feasibility and modeling capacity of minimaps. RQ3 addresses transparency and
model interpretability. RQ4 addresses the practical need to suppress business-
sensitive lexical content while preserving structural discriminability. RQ5
addresses the transition from offline experiments to software-engineering
practice.
...
\midrule
Representation & Source code minimaps: compact two-dimensional visual signatures produced for model consumption. & Validated (two studies) \\
