...
F1-score near 93\% in the evaluated setting \cite{gebara2025iwssip}. A second study
...
strategic domain knowledge---making external analysis impractical for industrial
codebases.
\end{quote}
...
content---identifiers, constants, comments---that exposes business logic and
intellectual property, limiting applicability in industrial settings. Third,
