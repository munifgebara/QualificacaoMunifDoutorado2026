...
Source Code Minimaps at Scale: Feature-Oriented Analysis of 100 Projects \cite{gebara2025ciarp} & CIARP 2025 & Main author & To appear \\
MinimapSignatures: A Multi-IDE Ecosystem for Analysis of Visual Source Code Signatures \cite{gebara2026minimapsignatures} & --- & Main author & In preparation \\
\bottomrule
\end{tabular}
\fautor
\end{table}
...
The deliverables are interdependent rather than isolated results: the dataset
and methodology feed the models, the models feed the explanation protocols, and
the explanations become the tool feedback that the developer-centered
...
program deadline for the doctoral defense.
