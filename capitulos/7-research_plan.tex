...
anonymization ablation of Section~\ref{sec:study3-anonymization}, which places
the confidentiality claim of the proposal on measured rather than anecdotal
ground.
...
The last two rows are targets rather than results. VISAPP 2027 is the venue
...
internship, with a regular paper deadline in September 2026 and the conference
held in February 2027. The journal target is \emph{Empirical Software
...
ablation are complete, so that the article reports consolidated rather than
...
The first instalment of this activity is already complete and is reported in
Section~\ref{sec:study3-anonymization}. A paired ablation over twelve classes
and 10,923 minimaps of an industrial system found no accuracy cost for
...
points, the value used and declared in the completed instalment. A drop beyond
...
S\'anchez Calle, from October 2026 to February 2027. The project registered for
...
The choice is not incidental. GAVAB's central line of work is the automatic
analysis of handwritten document images, which is the same class of problem
addressed here: extracting discriminative structure from images whose content is
thin, spatially organized strokes rather than objects with semantic boundaries.
...
internship period. And the writing of the methodology and results chapters is
deliberately placed after the return, so that the internship period is spent on
...
\midrule
July--August 2026 & Incorporate qualification feedback; freeze revised research questions and thesis structure; replicate the anonymization ablation (A2) on the open-source corpus. \\
September 2026 & Refine dataset catalog (A1); prepare and submit the VISAPP 2027 paper; organize the internship. \\
...
program deadline for the doctoral defense. The five months abroad are the main
constraint on this schedule rather than an interruption of it: the activities
