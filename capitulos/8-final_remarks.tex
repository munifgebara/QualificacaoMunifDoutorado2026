The document closes by restating the proposal in condensed form, weighing the
evidence that currently supports it, and stating the contribution the completed
thesis is expected to make. The aim is to make explicit what the qualification
committee is being asked to assess: not a finished result, but a direction that
the preliminary studies have shown to be viable and a plan proportionate to the
time remaining.
...
suppression on one large government system, even though the transformation
discards more than half of the information carried by each pixel; extending
that measurement to further corpora and models is planned work.
