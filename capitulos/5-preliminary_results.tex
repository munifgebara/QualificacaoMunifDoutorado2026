...
resulting setting focused on seven representative classes, including Java
entities, Java implementation classes, JSP pages, JavaScript, JSON, and SVG
files. This design provided a balanced enough scenario to test whether the
representation itself contained useful visual signals.
